...
0000000000400efc <phase_2>:   rdi   rsi
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp         rsp -= 40
  400f02:	48 89 e6             	mov    %rsp,%rsi       rsi = rsp
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers> wtf???
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)
  400f0e:	74 20                	je     400f30 <phase_2+0x34>  goto f30 when *(rsp) = 1需要 *(rsp)=1
  ...
  400f1e:	74 05                	je     400f25 <phase_2+0x29> goto f25 when eax=*(rbx)需要保持 
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx             rbx += 4
  400f29:	48 39 eb             	cmp    %rbp,%rbx             
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b> goto f17 when rbp != rbx
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> goto f3c
  ...
  400f3c:	48 83 c4 28          	add    $0x28,%rsp            rsp += 40
  400f40:	5b                   	pop    %rbx
  400f41:	5d                   	pop    %rbp
  400f42:	c3                   	ret
...
0000000000400f43 <phase_3>:
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax                         eax>=2
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>             跳过
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>             if *(rsp+8)>7 goto FLAG1//rsp[2]<=7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax                    eax = rsp[2]
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8)                goto CONST+rax*8
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                        eax=???
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>             goto FLAG2
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>             goto FLAG2
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>             goto FLAG2
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>             goto FLAG2
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>             goto FLAG2
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>             goto FLAG2
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax
  400fab:	eb 11                	jmp    400fbe <phase_3+0x7b>
  400fad:	e8 88 04 00 00       	call   40143a <explode_bomb>                 FLAG1
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax                         FLAG2     需要 eax=rsp[3]
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>
  400fc4:	e8 71 04 00 00       	call   40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp                                FLAG3
  400fcd:	c3                   	ret

0000000000400fce <func4>:       edx = 15,esi = 0,edi = input[0]    (a,b)
  400fce:	48 83 ec 08          	sub    $0x8,%rsp                    rsp -= 8
  400fd2:	89 d0                	mov    %edx,%eax                    
  400fd4:	29 f0                	sub    %esi,%eax                    eax = edx - esi   eax = a - b
  400fd6:	89 c1                	mov    %eax,%ecx                    
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                   
  400fdb:	01 c8                	add    %ecx,%eax                    eax += 自己的符号位  
  400fdd:	d1 f8                	sar    $1,%eax                      eax>>=1 arithmetic  
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx           ecx=eax+esi         tt=eax+b
  400fe2:	39 f9                	cmp    %edi,%ecx
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>          if ecx<=edi goto FLAG1    tt<=in0?
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx              edx = ecx-1         func4(tt-1,b)
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>               func4 AGAIN
  400fee:	01 c0                	add    %eax,%eax                    eax*=2              eax *= 2
  400ff0:	eb 15                	jmp    401007 <func4+0x39>          goto FLAG2          goto END
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax            FLAG1   eax = 0             eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx                    
  400ff9:	7d 0c                	jge    401007 <func4+0x39>          if ecx >= edi       goto END
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi               esi = ecx + 1       
  400ffe:	e8 cb ff ff ff       	call   400fce <func4>               func4 AGAIN         func4(a,tt+1)
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax        eax = eax * 2 + 1   eax = 2eax+1
  401007:	48 83 c4 08          	add    $0x8,%rsp            FLAG2   rsp += 8
  40100b:	c3                   	ret
...
void func(int a,int b){
  ...
  eax += fuhaowei
  eax >>= 1;
  int tt = eax + b; tt = (a+b)/2 向下取整（a>=b）   tt=
  if (tt <= lim) func4(tt-1,b),eax *= 2;
  if (tt >= lim) func4(a,tt+1),eax = eax*2+1;
}
...
000000000040100c <phase_4>:
  ...
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>        input
  401029:	83 f8 02             	cmp    $0x2,%eax                           需要 eax = 2
  40102c:	75 07                	jne    401035 <phase_4+0x29>               不管   
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)                      需要 *(rsp+8) <= 15
  401033:	76 05                	jbe    40103a <phase_4+0x2e>
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>               不管
  ...
  40104f:	75 07                	jne    401058 <phase_4+0x4c>               需要 eax=0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51>               需要 0=*(rsp+12)
...
0000000000401062 <phase_5>:
  ...
  401082:	74 4e                	je     4010d2 <phase_5+0x70>         需要 eax=6 goto FLG1
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx     FLG2   ecx = *(rbx + rax)
  40108f:	88 0c 24             	mov    %cl,(%rsp)                    *rsp = cl(rcx)
  401092:	48 8b 14 24          	mov    (%rsp),%rdx                   rdx = *rsp
  401096:	83 e2 0f             	and    $0xf,%edx                     edx &= (1111)_2
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx           edx = *(rdx + 0x4024b0)
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)         *(rsp + rax + 16) = dl(rdx)
  4010a4:	48 83 c0 01          	add    $0x1,%rax                     rax += 1
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                     
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>         if rax != 6 goto FLG2
  ...
  4010bd:	e8 76 02 00 00       	call   401338 <strings_not_equal>    call
  4010c2:	85 c0                	test   %eax,%eax                     需要 eax = 0
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>         if eax = 0 goto FLG3 
  4010c6:	e8 6f 03 00 00       	call   40143a <explode_bomb>
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)               
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax               FLG1  eax = 0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>         goto FLG2
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax         FLG3
...
for (int rax(eax) = 0;eax < 6;eax++){
  rcx(ecx) = *(rbx + rax)
  *rsp = rcx(cl)
  rdx = *rsp
  rdx(edx) &= 15                     rdx = rcx 的最后一个 byte
  *(rsp + 16 + rax) = rdx(dl)
}

call strings_not_equal         flyers    0x66 0x6c 0x79 0x65 0x72 0x73     9 f e 5 6 7
ionefg
...
00000000004010f4 <phase_6>:
  ...
  401106:	e8 51 03 00 00       	call   40145c <read_six_numbers>   读到了 (%rsp)
  40110b:	49 89 e6             	mov    %rsp,%r14                   r14=rsp
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                  r12d=0
  401114:	4c 89 ed             	mov    %r13,%rbp             FLG5  rbp=r13(=rsp)
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax              eax=input[0]
  40111b:	83 e8 01             	sub    $0x1,%eax                   eax-=1
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>       if 0 <= eax <= 5 goto FLG1 需要 inp[0-5]\in[1,6]
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d            FLG1  r12d+=1 
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d                  if r12d==6 goto FLG2
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx                  ebx=r12d
  401135:	48 63 c3             	movslq %ebx,%rax             FLG4  rax=ebx
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax          eax=input[rax]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51>       if eax!=*rbp goto FLG3 需要
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx             FLG3  ebx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx         
  40114b:	7e e8                	jle    401135 <phase_6+0x41>       if ebx <= 5 goto FLG4
  40114d:	49 83 c5 04          	add    $0x4,%r13                   r13 += 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20>       goto FLG5
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi       FLG2  rsi = rsp + 24
  401158:	4c 89 f0             	mov    %r14,%rax                   rax=r14
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                   ecx=7
  401160:	89 ca                	mov    %ecx,%edx             FLG6  edx=ecx
  401162:	2b 10                	sub    (%rax),%edx                 edx-=*rax
  401164:	89 10                	mov    %edx,(%rax)                 *rax=edx
  401166:	48 83 c0 04          	add    $0x4,%rax                   rax+=4
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>       if rax!=rsi goto FLG6
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                   esi=0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>       goto FLG7
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx        FLG10 rdx=*(rdx+8)       
  40117a:	83 c0 01             	add    $0x1,%eax                   eax+=1
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>       if eax!=ecx goto FLG10
  401181:	eb 05                	jmp    401188 <phase_6+0x94>       goto FLG11
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx        FLG8  edx=0x6032d0
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)FLG11 *(rsp+rsi*2+32)=rdx
  40118d:	48 83 c6 04          	add    $0x4,%rsi                   rsi+=4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>       if rsi==24 goto FLG9
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx    FLG7  ecx = *(rsp+rsi)
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>       if ecx<=1 goto FLG8
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                   eax=1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx              edx=0x6032d0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>       goto FLG10
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx       FLG9  rbx=*(rsp+32)
  ...
  4011bd:	48 8b 10             	mov    (%rax),%rdx           FLG13 rdx=*rax
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)              *(rcx+8)=rdx
  4011c4:	48 83 c0 08          	add    $0x8,%rax                   rax+=8
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>       if rsi==rax goto FLG12
  4011cd:	48 89 d1             	mov    %rdx,%rcx                   rcx=rdx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>       goto FLG13
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)        FLG12 *(rdx+8)=0
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp                   ebp=5
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax        FLG14 rax=*(rbx+8)
  4011e3:	8b 00                	mov    (%rax),%eax                 eax=*rax
  4011e5:	39 03                	cmp    %eax,(%rbx)                 
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>       if *rbx>=eax goto FLG15 需要
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx        FLG15 rbx=*(rbx+8)
  4011f2:	83 ed 01             	sub    $0x1,%ebp                   ebp-=1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb>       if ebp!=0 goto FLG14
...
000000000040145c <read_six_numbers>:
  ...
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi      esi = 
